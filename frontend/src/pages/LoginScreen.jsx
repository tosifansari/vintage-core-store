...
const LoginScreen = () => {
    ...
    return (
        <div className="max-w-md mx-auto my-12 p-8 bg-neutral-900 border border-amber-900/10 rounded-xl space-y-6 shadow-xl">
            <div className="text-center space-y-2">
                <h1 className="font-serif text-3xl text-stone-100 tracking-wide">Sign In</h1>
                <p className="text-xs text-stone-400 font-light uppercase tracking-widest">Access Premium Collection</p>
            </div>
            ...
            <div className="text-center pt-2 border-t border-stone-800 text-sm font-light text-stone-400">
                New Collector? <Link to={redirect !== '/' ? `/register?redirect=${redirect}` : '/register'} className="text-amber-500 hover:underline">Create Account</Link>
            </div>
        </div>
    );
};
